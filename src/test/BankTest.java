...
class BankTest {
    ...
    void CreateBank() {
        ...
        for (Resource resource : Resource.values()) // create resources / exist resources
            assertFalse(bank.hasResource(resource, Component.RESOURCES_BY_TYPE + 1));
        ...
        for (Player player : players) // create roads / get number of roads
            Assertions.assertEquals(Component.ROADS, bank.getRoadsNumber(player));
    ...
    void takeResource() {
        ...
        if (bank.removeResource(Resource.brick) != null &&
                bank.removeResource(Resource.grain) != null &&
                bank.removeResource(Resource.lumber) != null &&
                bank.removeResource(Resource.ore) != null &&
                bank.removeResource(Resource.wool) != null)
    ...
    void takeRoad() {
        ...
        for (int index = 0; index < Component.ROADS; index++) {
            ...
            assertNull(bank.removeRoad(players.get(1)));
    ...
    void takeSettlement() {
        ...
        for (int index = 0; index < Component.SETTLEMENTS; index++) {
            ...
            assertNull(bank.removeSettlement(players.get(2)));
        }
    ...
    void takeCity() { // exista o greseala in cod
        ...
        for (int index = 0; index < Component.CITIES; index++) {
            ...
            assertNull(bank.removeCity(players.get(3)));
        }
